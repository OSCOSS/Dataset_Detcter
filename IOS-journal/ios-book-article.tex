...
%newpart_22>
 ...
 It has published research on all aspects of science of surveys, be it on data collection, measurement, or data analysis and statistics\todo{CL@BG/PM: I commented the following sentence as it read too much like an advertisement of mda and didn't add relevant information about our research.}.
...
\todo{CL@BG/PM: Once more this is IMHO a bit too much advertising {\dara}.  Can't we simply write “{\dara} assigns a DOI to each dataset”?}{\dara} makes social science research data referable and thus improves its availability. 
%<newpart_24
This is achieved by assigning a DOI to each dataset.
...
This metadata is exposed to harvesters employing a freely accessible API using OAI-PMH (Open Archives Initiative Protocol for Metadata Harvesting\footnote{\url{http://da-ra.de/oaip/}}). 
  ...
  Finally, there are \emph{phrases} that explicitly denote the existence of \todo{CL@BG: of \emph{datasets}, or actually of dataset \emph{references}?}datasets in a text, such as \enquote{Exit Poll} or \enquote{Probation Survey}.
